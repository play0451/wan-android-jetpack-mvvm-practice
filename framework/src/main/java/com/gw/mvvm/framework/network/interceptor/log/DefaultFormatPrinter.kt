package com.gw.mvvm.framework.network.interceptor.log

import android.text.TextUtils
import android.util.Log
import com.gw.mvvm.framework.ext.utils.logd
import com.gw.mvvm.framework.utils.CharacterHandler
        ...
        private fun logLines(
            ...
            for (line in lines) {
                ...
                for (i in 0..lineLength / maxLongSize) {
                    ...
                    (DEFAULT_LINE + line.substring(start, end)).logd(resolveTag(tag))
                }
            }
        }
