...
#okhttp,实际上okhttp的混淆规则已经打在jar包里了,所以不需要额外添加,这里仅做记录
...
#BaseRecyclerViewAdapterHelper,https://github.com/CymChad/BaseRecyclerViewAdapterHelper/issues/3345
...
#我们需要确保这些js要调用的原生方法不能够被混淆,所以需要保持有JavaScript接口的类
#例如,修改对应路径即可
#-keepclassmembers class fqcn.of.javascript.interface.for.webview {
#   public *;
#}
#此行解决android sdk api >= 17 时需要加@JavascriptInterface所出现的问题
#-keepattributes JavascriptInterface

#实体类,只要会被反射的类都得保持,例如Json数据转对象
-keep class com.gw.mvvm.wan.data.model.** { *; }
-dontwarn  com.gw.mvvm.wan.data.model.**
-keep class com.gw.mvvm.wan.core.network.ApiResponse { *; }
-dontwarn  com.gw.mvvm.wan.core.network.ApiResponse
